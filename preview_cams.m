...
%% Establish Connection to Bluetooth
% NOTE : Make sure the laptops Bluetooth is On
% The device name is PUPILv2.
% The passcode of the Bluetooth is 1234.
